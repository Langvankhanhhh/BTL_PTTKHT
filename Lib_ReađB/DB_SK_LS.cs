...
namespace Lib_ReađB
{
    public class DB_SK_LS
    {
        ...
        public string add_member(string id_sk, string ten_sk, string ma_ta, string nggay_batdau, string ngay_ketthuc, string loai_sk)
        {
            string json = "";
        ...
        public string delete_member(string id_sk)
        {
            string json = "";
            try
            {
